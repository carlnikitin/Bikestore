...
- CRUD Bikes
- CR*D Comments on bikes (no updating required)
- GET and display paginated lists of bikes
- Favorite bikes
- Follow other users
...
- Home page (URL: /#/ )
    - List of tags
    - List of bikes pulled from either Feed, Global, or by Tag
    - Pagination for list of bikes
- Sign in/Sign up pages (URL: /#/login, /#/register )
    - Use JWT (store the token in localStorage)
- Settings page (URL: /#/settings )
- Editor page to create/edit bikes (URL: /#/editor, /#/editor/bike-slug-here )
- Bike page (URL: /#/bike/bike-slug-here )
    - Delete bike button (only shown to bike's author)
    - Render markdown from server client side
    - Comments section at bottom of page
    - Delete comment button (only shown to comment's author)
- Profile page (URL: /#/@username, /#/@username/favorites )
    - Show basic user info
    - List of bikes populated from author's created bikes or author's favorited bikes
